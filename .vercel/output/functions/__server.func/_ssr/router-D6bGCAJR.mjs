...
import { t as Route$13 } from "./carreras-DzNJuRKE.mjs";
import { t as Route$14 } from "./carreras._slug-ECNAXgbj.mjs";
import { t as Route$15 } from "./examen-DXI9VJhe.mjs";
import { t as Route$16 } from "./test-BAHgRmIT.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-D6bGCAJR.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-vUM-Wxd5.css";
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
					...
					children: allItems.filter((item) => !role || item.roles.includes(role)).map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: item.to,
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
						...
						children: [
							isVisible(["student"]) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								to: "/test",
								onClick: (e) => handleLinkClick(e, true),
								className: "hover:text-primary transition-colors",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
						...
						children: [
							...
							isVisible(["parent"]) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								to: "/padres",
								onClick: (e) => handleLinkClick(e, true),
								className: "hover:text-primary transition-colors",
								children: "Para Padres"
							}) }),
							isVisible(["school"]) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								to: "/colegios",
								onClick: (e) => handleLinkClick(e, true),
								className: "hover:text-primary transition-colors",
...
var $$splitComponentImporter$11 = () => import("./resultados-JQ7Y-C88.mjs");
var Route$11 = createFileRoute("/resultados")({
	head: () => ({ meta: [{ title: "Tu ADN Profesional — Alex IA" }] }),
	component: lazyRouteComponent($$splitComponentImporter$11, "component")
});
var $$splitComponentImporter$10 = () => import("./recuperar-clave-BSl6HSxt.mjs");
var Route$10 = createFileRoute("/recuperar-clave")({
	head: () => ({ meta: [{ title: "Recuperar Contraseña — Alex IA" }] }),
	component: lazyRouteComponent($$splitComponentImporter$10, "component")
});
var $$splitComponentImporter$9 = () => import("./privacidad-DhNOwGoR.mjs");
var Route$9 = createFileRoute("/privacidad")({
	head: () => ({ meta: [{ title: "Política de Privacidad — Alex IA" }] }),
	component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
var $$splitComponentImporter$8 = () => import("./padres-zjqBsNT8.mjs");
var Route$8 = createFileRoute("/padres")({
...
var $$splitComponentImporter$7 = () => import("./login-BCVMxH1J.mjs");
var Route$7 = createFileRoute("/login")({
	head: () => ({ meta: [{ title: "Iniciar Sesión — Alex IA" }] }),
	component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
var $$splitComponentImporter$6 = () => import("./colegios-Bj6BKIWY.mjs");
var Route$6 = createFileRoute("/colegios")({
...
var $$splitComponentImporter$5 = () => import("./coach-DPH6AZx1.mjs");
var Route$5 = createFileRoute("/coach")({
...
var $$splitComponentImporter$4 = () => import("./bienvenida-BTV3GXN-.mjs");
...
var $$splitComponentImporter$2 = () => import("./routes-CqSjQ76Z.mjs");
...
var $$splitComponentImporter$1 = () => import("./registro.padre-DhVwLmz8.mjs");
var Route$1 = createFileRoute("/registro/padre")({
	head: () => ({ meta: [{ title: "Registro Padres — Alex IA" }] }),
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./registro.estudiante-DpqxZEox.mjs");
var Route = createFileRoute("/registro/estudiante")({
	head: () => ({ meta: [{ title: "Registro Estudiante — Alex IA" }] }),
	component: lazyRouteComponent($$splitComponentImporter, "component")
});
var TestRoute = Route$16.update({
	id: "/test",
	path: "/test",
	getParentRoute: () => Route$12
});
var ResultadosRoute = Route$11.update({
	id: "/resultados",
	path: "/resultados",
	getParentRoute: () => Route$12
});
var RecuperarClaveRoute = Route$10.update({
	id: "/recuperar-clave",
	path: "/recuperar-clave",
	getParentRoute: () => Route$12
});
var PrivacidadRoute = Route$9.update({
	id: "/privacidad",
	path: "/privacidad",
	getParentRoute: () => Route$12
});
var PadresRoute = Route$8.update({
	id: "/padres",
	path: "/padres",
	getParentRoute: () => Route$12
});
...
var ExamenRoute = Route$15.update({
	id: "/examen",
	path: "/examen",
	getParentRoute: () => Route$12
});
var ColegiosRoute = Route$6.update({
	id: "/colegios",
	path: "/colegios",
	getParentRoute: () => Route$12
});
var CoachRoute = Route$5.update({
	id: "/coach",
	path: "/coach",
	getParentRoute: () => Route$12
});
var CarrerasRoute = Route$13.update({
	id: "/carreras",
	path: "/carreras",
	getParentRoute: () => Route$12
});
...
var CarrerasRouteChildren = { CarrerasSlugRoute: Route$14.update({
	id: "/$slug",
	path: "/$slug",
