...
import { V as ArrowLeft, j as CircleCheck, l as Sparkles, v as LoaderCircle } from "../_libs/lucide-react.mjs";
import { n as useAuth } from "./use-auth-CKsLygXF.mjs";
import { n as mockAdnProfile } from "./mock-data-TXde_zSy.mjs";
import { t as Route } from "./test-BAHgRmIT.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/test-6u9yUUlZ.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function TestPage() {
	const navigate = useNavigate();
	const testDimensions = Route.useLoaderData();
	const { user } = useAuth();
	...
	const handleNext = async (opt) => {
		const finalOpt = opt !== void 0 ? opt : sliderVal.toString();
		setSelectedOption(opt || null);
		setIsSaving(true);
		try {
			if (user) await supabase.from("test_answers").insert({
			...
			setIsSaving(false);
			if (opt !== void 0) setTimeout(() => proceedToNext(), 400);
			else proceedToNext();
		}
	};
	const proceedToNext = async () => {
		...
		if (qIdx + 1 < dim.questions.length) {
			...
			setIsSaving(true);
			try {
				if (user) await supabase.from("test_results").insert({
					auth_user_id: user.id,
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									children: isSaving ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-5 w-5 animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: ["Confirmar ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "h-5 w-5" })] })
								})
							]
						});
					})()
