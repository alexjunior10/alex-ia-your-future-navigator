...
import { M as Check, R as BrainCircuit, T as GraduationCap, c as Target, l as Sparkles, n as X, o as TriangleAlert, p as MessageCircle, z as BookOpen } from "../_libs/lucide-react.mjs";
import { n as mockAdnProfile, t as careers } from "./mock-data-TXde_zSy.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/resultados-JQ7Y-C88.js
...
function ResultsPage() {
	...
	const [showCoachPopup, setShowCoachPopup] = (0, import_react.useState)(false);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			showCoachPopup && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "fixed bottom-6 right-6 z-50 animate-in slide-in-from-bottom-10 fade-in duration-500",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "relative rounded-3xl border border-border bg-card p-6 shadow-2xl max-w-[300px]",
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "👋 Vi tu resultado, ¿quieres que conversemos sobre qué significa para ti este ADN?"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							to: "/coach",
							className: "flex w-full justify-center items-center gap-2 rounded-xl bg-primary px-4 py-2.5 text-sm font-bold text-primary-foreground transition-transform hover:scale-105",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageCircle, { className: "h-4 w-4" }), " Conversar ahora"]
						})
					]
				})
			})
