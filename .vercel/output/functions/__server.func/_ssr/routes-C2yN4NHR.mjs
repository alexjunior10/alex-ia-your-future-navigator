...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-C2yN4NHR.js
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 -z-10 bg-gradient-to-br from-primary/10 via-background to-secondary/10" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mx-auto grid max-w-6xl items-center gap-10 px-4 py-12 sm:px-6 md:grid-cols-2 md:py-16",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				className: "mx-auto max-w-6xl px-4 pb-16 sm:px-6 relative z-10 -mt-12",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
