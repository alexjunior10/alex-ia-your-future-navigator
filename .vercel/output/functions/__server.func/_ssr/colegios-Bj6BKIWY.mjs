...
import { N as ChartColumn, g as LogOut, j as CircleCheck, r as Users, z as BookOpen } from "../_libs/lucide-react.mjs";
import { n as useAuth } from "./use-auth-CKsLygXF.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/colegios-Bj6BKIWY.js
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "rounded-3xl bg-gradient-to-br from-primary to-secondary p-10 text-primary-foreground shadow-xl flex-1 w-full",
					...
					onClick: logout,
					className: "shrink-0 flex items-center gap-2 rounded-xl border-2 border-border bg-background px-5 py-3 font-semibold text-foreground hover:border-destructive hover:text-destructive transition-colors",
