...
import { F as Building2, H as Activity, O as Clock, a as Trophy, c as Target, w as HeartHandshake, z as BookOpen } from "../_libs/lucide-react.mjs";
import { t as Route } from "./examen-DXI9VJhe.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/examen-g7IMWLZY.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function ExamenPage() {
	const { careers, admissionExams } = Route.useLoaderData();
	...
	(0, import_react.useEffect)(() => {
		...
		} else if (timeLeft === 0 && started && !finished) setFinished(true);
	}, [
		timeLeft,
		started,
		finished
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: `flex items-center gap-1.5 font-mono text-lg font-bold ${timeLeft < 60 ? "text-destructive animate-pulse" : "text-primary"}`,
					children: [
					...
					className: "hidden sm:inline-block rounded-full bg-accent/20 px-3 py-1 text-xs font-bold text-accent-foreground",
