    ...
    <div className="overflow-hidden">
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-8 sm:px-6 md:grid-cols-2 md:py-12">
          <div className="animate-fade-in">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Link to="/test" onClick={handleTestClick} className="inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/25 transition-transform hover:scale-105 hover:bg-primary/90">
      ...
      <section className="mx-auto mt-16 max-w-6xl px-4 sm:px-6">
        <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-primary to-secondary p-10 text-center text-primary-foreground shadow-xl">
          ...
          <Link to="/test" onClick={handleTestClick} className="mt-6 inline-flex items-center gap-2 rounded-full bg-background px-6 py-3 text-sm font-semibold text-primary shadow-lg hover:scale-105 transition-transform">
